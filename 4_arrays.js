...
empNames.forEach((name) => console.log(`${name} received the reward for overtime`));
...
const bookshelf = ['The Song of Ice and Fire', 'The Last Wish', 'Metro 2033', 'The Godfather'];
